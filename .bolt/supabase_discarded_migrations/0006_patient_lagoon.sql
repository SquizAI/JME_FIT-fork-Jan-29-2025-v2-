/*
  # Add memberships table and policies
  ...
  2. Security
    ...
    - Add policy for public read access to active memberships
...
VALUES
    (
        ...
        '["Access to workout library", "Basic progress tracking", "Community support"]',
        29.99,
        299.99,
        'active',
        false
    ...
    (
        ...
        '["Everything in Basic", "Custom workout plans", "Nutrition guidance", "Priority support"]',
        49.99,
        499.99,
        'active',
        true
    ...
    (
        ...
        '["Everything in Pro", "1-on-1 coaching", "Custom meal plans", "Weekly check-ins", "Video form checks"]',
        99.99,
        999.99,
        'active',
        false
