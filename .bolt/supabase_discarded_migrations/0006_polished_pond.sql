/*
  # Update Memberships Content

  Updates the memberships table with the exact content provided, including:
  - App Workouts Only (Self-Led and Trainer Feedback)
  - Nutrition Only (12-Week Program)
  - Plus Membership (12-Week Program)
*/
