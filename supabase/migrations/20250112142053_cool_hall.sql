...
ALTER TABLE public.products
  ADD COLUMN IF NOT EXISTS type text CHECK (type IN ('apparel', 'supplement', 'equipment', 'digital')) NOT NULL DEFAULT 'apparel';

-- Update existing products with proper types
...
-- Add sample products with proper types
